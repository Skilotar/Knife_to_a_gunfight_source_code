...
namespace Knives
{
    class punk_helm :PassiveItem
    {
        ...
        public static void Register()
        {
            ...
            string longDesc = "This helmet is a beautiful technicolor display of lights and sounds. Unfortunatly it only has a single left headphone and half of the lyrics to its song are coming out.";
