...
namespace Knives
{
    ...
    public class Queen : GunBehaviour
    {
        ...
        public static void Add()
        {
            ...
            gun.encounterTrackable.EncounterGuid = "BITE ZA DUSTO!";
        ...
        public AIActor orLoadByGuid = EnemyDatabase.GetOrLoadByGuid("c0260c286c8d4538a697c5bf24976ccf");
        public static AIActor aiactor;

        public void nytraPlacer(PlayerController owner)
        {
            aiactor = AIActor.Spawn(orLoadByGuid.aiActor, owner.unadjustedAimPoint, GameManager.Instance.Dungeon.data.GetAbsoluteRoomFromPosition(IntVector2.Zero), true, AIActor.AwakenAnimationType.Default, true);
