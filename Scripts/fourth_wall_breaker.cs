...
namespace Knives
{
    ...
    public class fourth_wall_breaker : GunBehaviour
    {
        public float dura = 5;
        public static void Add()
        {
            ...
            gun.SetLongDescription("A legendary shotgun fortold to be able to shatter the foundation of the gungeon itself. The power lies inside the third barrel that kills things more deader than ever before.");
            ...
            gun.DefaultModule.angleVariance = 100f;
        ...
        public override void OnPostFired(PlayerController player, Gun gun)
        {
            ...
            AkSoundEngine.PostEvent("Play_PET_pig_cry_01", gameObject);
