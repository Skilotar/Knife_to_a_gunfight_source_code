	...
	class SCP_323 : PassiveItem
	{
		public static void Register()
		{
			...
			string longDesc = "Humanoid class creatures who don this skull are rapidly altered into a creature of emense might and fortitude but also of great hunger. \n\n" +
				"These 'Wendigo' more formerly known as SCP-323-1, require nearly constant food intake or else face starvation over time. Unfortunatly for you, if you can read this description you are likely already a SCP-323-1. \n" +
