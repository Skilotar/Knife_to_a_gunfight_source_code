...
namespace Knives
{
    class ChamberofChambers : PassiveItem
    {
        ...
        public static void Register()
        {
            ...
            string longDesc = "A strange invention created by the Duke of the chamber. This chamber has 6 smaller chambers inlayed into itself. With this you can instantly reload 6 times before having to refill the whole chamber. " +
