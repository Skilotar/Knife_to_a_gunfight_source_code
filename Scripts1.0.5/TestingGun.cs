...
namespace Knives
{
    ...
    class testing_gun : AdvancedGunBehaviour
    {
        ...
        public static void Add()
        {
            ...
            gun.AddProjectileModuleFrom("Camera_Gun", true, false);
        ...
        public override void OnPostFired(PlayerController player, Gun gun)
        {
            ...
            if (shotcountcontroller == 1)
            {
                ...
                if (flag)
                {
                    ...
                    component1.baseData.damage = 15f;
                    component1.AppliesStun = true;
                    component1.AppliedStunDuration = 3f;
        ...
        public GrappleModule Hook = new GrappleModule();
        public GameObject GrapplePrefab;
        
        public float GrappleSpeed = 10f;
        public float GrappleRetractSpeed = 10f;
        public float DamageToEnemies = 15f;
