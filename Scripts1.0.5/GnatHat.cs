...
namespace Knives
{
    class GnatHat :PlayerItem
    {
        public static void Register()
        {
            ...
            "Dev notes: DONT PICKUP OR DROP GUNS WHILE ACTIVE. I tried to fix this so much and every fix adds more bugs. turns out the game REALLY doesnt like it when you mess with sprite scales. who whould have though huh.  " +
