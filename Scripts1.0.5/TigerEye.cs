    ...
    class Eye_of_the_tiger : PlayerItem
    {
        public static void Register()
        {
            ...
            string longDesc = "It's the eye of that tiger\n" +
                ...
                "It's all from stealing the eye of that tiger!!!!\n\n______________________________\n"+
                "Damages the player and summons tigers. These particular " +
                "tigers are pissed with you for sealing their eyes. However they can't exactally " +
        ...
        protected override void DoEffect(PlayerController user)
        {
            ...
            GameObject gameObject2 = SpawnManager.SpawnProjectile(projectile.gameObject, base.transform.position.XY(), Quaternion.Euler(0f, 0f, z), true);
            GameObject gameObject3 = SpawnManager.SpawnProjectile(projectile.gameObject, base.transform.position.XY(), Quaternion.Euler(0f, 0f, z), true);
            GameObject gameObject4 = SpawnManager.SpawnProjectile(projectile.gameObject, base.transform.position.XY(), Quaternion.Euler(0f, 0f, z), true);
            GameObject gameObject5 = SpawnManager.SpawnProjectile(projectile.gameObject, base.transform.position.XY(), Quaternion.Euler(0f, 0f, z), true);
