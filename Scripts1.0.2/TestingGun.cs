...
namespace Knives
{
    ...
    public class testing_gun : GunBehaviour
    {
        ...
        public System.Random rngX = new System.Random();
        public System.Random rngY = new System.Random();
        public override void OnPostFired(PlayerController player, Gun gun)
        {
            //This determines what sound you want to play when you fire a gun.
            //Sounds names are based on the Gungeon sound dump, which can be found at EnterTheGungeon/Etg_Data/StreamingAssets/Audio/GeneratedSoundBanks/Windows/sfx.txt
            gun.PreventNormalFireAudio = true;
            float y = rngY.Next(-1,2);
            float x = rngX.Next(0,3);
            this.gun.barrelOffset.transform.localPosition = new Vector3(x, y, 0f);
