...
namespace Knives
{
    ...
    { 
        public static void Register()
        {
            ...
            ItemBuilder.AddPassiveStatModifier(item, PlayerStats.StatType.DodgeRollDamage, 9f, StatModifier.ModifyMethod.ADDITIVE);
           
            ItemBuilder.AddPassiveStatModifier(item, PlayerStats.StatType.ReloadSpeed, 1.8f, StatModifier.ModifyMethod.ADDITIVE);
        ...
        public void OnLoadedFloor(PlayerController player) 
        {
            ...
            AddStat(PlayerStats.StatType.DodgeRollDamage, (GameManager.Instance.GetLastLoadedLevelDefinition().enemyHealthMultiplier - 1) * 10  + 9f);
