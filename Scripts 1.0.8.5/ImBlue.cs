...
namespace Knives
{
    class Im_blue :PassiveItem
    {
        public static void Register()
        {
            ...
            ItemBuilder.AddPassiveStatModifier(item, PlayerStats.StatType.EnemyProjectileSpeedMultiplier, -.50f, StatModifier.ModifyMethod.ADDITIVE);
            ItemBuilder.AddPassiveStatModifier(item, PlayerStats.StatType.ProjectileSpeed, -.50f, StatModifier.ModifyMethod.ADDITIVE);
