...
namespace Knives
{
    class Long_roll_boots : PassiveItem
    {
        ...
        public static void Register()
        {
            ...
            string longDesc = "An apeture science prototype for the long fall boots. This early model attempted to negate falling injuries by slowing the timestream of the person jumping. Turns out slowing time doesnt slow momentum. The subjects still splatted... just really slowly.\n\n" +
