...
namespace Knives
{
    class Corrupted_persuasive_bullets : PassiveItem
    {
        public static void Register()
        {
            //The name of the item
            string itemName = "Corrupt Persuasive bullets";
            ...
            var item = obj.AddComponent<Corrupted_persuasive_bullets>();

            //Adds a sprite component to the object and adds your texture to the item sprite collection
            ItemBuilder.AddSpriteToObject(itemName, resourceName, obj);

            //Ammonomicon entry variables
            string shortDesc = "Follow who's orders?";
            string longDesc =
        ...
        {
            base.Update();
            BraveInput.GetInstanceForPlayer(0).IsKeyboardAndMouse(true);
