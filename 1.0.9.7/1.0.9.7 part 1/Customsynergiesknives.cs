    ...
    class Customsynergiesknives
    {
        ...
        public class DC : AdvancedSynergyEntry
        {
            public DC()
            {
                ...
                this.MandatoryItemIDs = new List<int> //Look in the items ID map in the gungeon code for the ids.
                {
                    PickupObjectDatabase.GetByEncounterName("Hell's Bell").PickupObjectId,
                   

                };
                this.OptionalItemIDs = new List<int>
                {
                     PickupObjectDatabase.GetByEncounterName("Aged Bell").PickupObjectId,
                     

                };
                this.OptionalGunIDs = new List<int>
                {
                     PickupObjectDatabase.GetByEncounterName("Really Special Lute").PickupObjectId,
        ...
        public class AC : AdvancedSynergyEntry
        {
            public AC()
            {
                ...
                this.OptionalGunIDs = new List<int>
                {
                     PickupObjectDatabase.GetByEncounterName("Face Melter").PickupObjectId,
                     PickupObjectDatabase.GetByEncounterName("Helix").PickupObjectId,
                     PickupObjectDatabase.GetByEncounterName("GuNNER").PickupObjectId,
        ...
        public class Mas_Queso : AdvancedSynergyEntry
        {
            public Mas_Queso()
            {
                ...
                this.MandatoryItemIDs = new List<int> //Look in the items ID map in the gungeon code for the ids.
                {
                    PickupObjectDatabase.GetByEncounterName("Sheila").PickupObjectId,


                };
                this.OptionalItemIDs = new List<int>
                {
                     PickupObjectDatabase.GetByEncounterName("Rat Boots").PickupObjectId,
                     PickupObjectDatabase.GetByEncounterName("Resourceful Sack").PickupObjectId,
                     PickupObjectDatabase.GetByEncounterName("Partially-Eaten Cheese").PickupObjectId,
                ...
                this.OptionalGunIDs = new List<int>
                {
                     PickupObjectDatabase.GetByEncounterName("Elimentaler").PickupObjectId,
